    ...
    return {
      nodes: [
        ...
        },
        {
          ...
          host: "10.239.86.199",
          path: "/cmdb/ep/jar",
          desc: "包含了CMDB配置项、圈子、首页、全文检索、消费接口、同步接口等模块。",
          icon: pc,
        ...
        },
        {
          ...
          host: "10.239.86.199",
          path: "/cmdb/ep/jar",
          desc: "用于对机房的物理设备进行盘盈盘亏以及通过二维码扫描的方式查询资源详细信息。",
          icon: pc,
        ...
        },
        {
          ...
          desc: "包含了CMDB配置项、圈子、首页、全文检索、消费接口、同步接口、告警查询、自动发现等功能。",
          icon: ie,
          value: [400, 450],
          offset: [0, 0]
        },
        ...
        },
        {
          ...
          path: "-",
          icon: app,
          desc: "通过连接外网可以在直接通过网络直接将数据传输到后台进行解析处理最终得到需要的信息。",
          url: "http://117.169.37.163:8084/index.html",
          value: [450, 350],
          offset: [0, 0]
        },
        {
          ...
          desc: "自动发现采集部署机器,包含IP发现、主机发现、网络设备发现、中间件发现、数据库发现等资源采集功能。",
          icon: pc,
          value: [50, 250],
          offset: [0, 0]
        },
        ...
        },
        {
          ...
          host: "10.239.86.200",
          path: "-",
          desc: "用于判定自动发现部署的客户端是否有信息回馈，方便部署人员排查相应机器是否已挂掉。",
          icon: pc,
        ...
        {
          name: "BOMC",
          desc: "将CMDB现有的资源以全量或增量的方式同步给BOMC，另外BOMC将资源告警配置、性能配置、历史告警等数据同步给CMDB。",
          icon: pc,
          value: [50, 550],
          offset: [0, 0]
        },
        {
          name: "CRM",
          desc: "将CMDB现有的中间件、数据库等资源同步给CRM，另外CRM将账号相关等资源同步给CMDB。",
          icon: pc,
          value: [70, 550],
          offset: [0, 0]
        },
        {
          name: "AIOps",
          desc: "将CMDB现有的资源以全量或增量的方式同步给BOMC，方便AiOps进行学习分析资源的走向等。",
          icon: pc,
          value: [90, 550],
          offset: [0, 0]
        },
      ...
      lines: [
        ...
        {
          desc: "CMDB",
          coords: [[150, 450], [50, 450]]
        },
        {
          desc: "CMDB",
          coords: [[250, 450], [150, 450]]
        },
        {
          desc: "CMDB",
          coords: [[400, 450], [250, 450]]
        },
        {
          desc: "APP",
          coords: [[50, 350], [0, 350]]
        ...
        {
          desc: "APP",
          coords: [[400, 350], [50, 350]]
        },
        {
          desc: "APP",
          coords: [[450, 350], [400, 350]]
        },
        {
          desc: "自动发现",
        ...
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[100, 250], [0, 350]]
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[150, 250], [0, 350]]
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[200, 250], [0, 350]]
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[250, 250], [0, 350]]
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[300, 250], [0, 350]]
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[350, 250], [0, 350]]
        },
        {
          desc: "自动发现",
          link_color: "rgba(245,153,137, 1)",
          coords: [[400, 250], [0, 350]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [50, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [100, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [150, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [200, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [250, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [300, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [350, 250]]
        },
        {
          desc: "心跳",
          link_color: "rgba(245,153,137, 1)",
          coords: [[450, 150], [400, 250]]
        },
        {
          source: "IT资源管理系统后台\n10.239.86.199",
          target: "BOMC",
          ref: "同步",
          desc: "接口",
          coords: [[50, 450] , [50, 550]]
        },
        {
          desc: "接口",
          coords: [[50, 550],[50, 450]]
        },
        {
          source: "IT资源管理系统后台\n10.239.86.199",
          target: "CRM",
          ref: "同步",
          desc: "接口",
          coords: [[50, 450], [70, 550]]
        },
        {
          desc: "接口",
          coords: [[70, 550], [50, 450]]
        },
        {
          source: "IT资源管理系统后台\n10.239.86.199",
          target: "AIOps",
