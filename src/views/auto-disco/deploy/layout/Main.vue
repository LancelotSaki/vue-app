    ...
    <aside class="tabShow">
      <nav v-for="tab of tabGroup" :key="tab.id">
        <input
          ...
          :checked="tab.check"
        />
        <label :for="tab.id" :title="tab.title" @click="selectTable(tab.value)"
          ><img :src="tab.img" width="20" height="20"
        /></label>
      </nav>
    </aside>
