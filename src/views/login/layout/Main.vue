<template>
  <main>
    ...
    <form @submit="checkForm1" action="https://www.baidu.com" method="post">
      <input
        type="text"
        name="username"
        placeholder="邮箱/手机号码"
      ...
      <input
        ...
        :disabled="sendClickDisable"
        @click="clickSend"
      />
      <input type="submit" value="登 录" />
      <a href="http://www.baidu.com" target="_blank">忘记密码?</a>
      <div class="alterTab1" :data-words="checkBox.usernameCheck">
...
export default {
  ...
  mounted() {
    ...
    if (saveTime && saveTime !== "" && parseInt(saveTime, 10) > currentTime) {
